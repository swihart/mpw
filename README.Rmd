...
The goal of mpw is to facilitate estimating Marginalized Piecewise Weibull Frailty Models in R.

There are articles on the webpage for this package that work through
examples of Marginalized Piecewise Weibull Frailty 
Models in R.  Please consult the following articles:
