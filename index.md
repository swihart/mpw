...
![](reference/figures/README-example_alpha-1.png)
...
![](reference/figures/README-example_alpha-2.png)
...
![](reference/figures/README-example_beta-1.png)
...
![](reference/figures/README-example_beta-2.png)

## Inverse Gaussian($1,\lambda$) Example

This is the $F_{\lambda}$ referenced in the manuscript.

- $F_{\lambda}(x) = 1 - \exp\left\lbrack - \lambda\left( \left( 1 + \frac{2}{\lambda}\exp\eta \right)^{\frac{1}{2}} - 1 \right) \right\rbrack$
...
![](reference/figures/README-example_lambda-1.png)
...
![](reference/figures/README-example_lambda-2.png)

## Two-Point($\rho$, $\xi$) Example

This is the $F_{\rho}$ referenced in the manuscript.

- $F_{\rho}(x) = 1 - \left( (1 - \rho)\exp\left\lbrack - \xi\exp\eta \right\rbrack + \rho\exp\left\lbrack - \xi^{\prime}\exp\eta \right\rbrack \right)$
...
![](reference/figures/README-example_rho-1.png)
...
![](reference/figures/README-example_rho-2.png)
...
![](reference/figures/README-example_omega-1.png)
...
![](reference/figures/README-example_omega-2.png)
