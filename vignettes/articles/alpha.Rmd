...
#abline(v=tvec.in, lty=2, col="grey",lwd=)

#axis(1, at=c(tvec.in[1]))

```

The plot above shows that for a $\alpha = $ `r h_parm` and a positive-stable frailty, the subject-specific HR is flatter and lower than the population average HR.
