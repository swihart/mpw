...
plot  (time.haz, vacc.haz/plac.haz, type="l", col="purple", xlab="Days", ylab="Hazard", lwd=2)
...
lines  (time.haz, vacc.haz.ss/plac.haz.ss, type="l", col="gold", xlab="Days", ylab="Hazard", lty=2, lwd=2)
