...
So we run a loop for three specific values of alpha:
...
```
The plot above shows that for a positive-stable frailty, as $\alpha$ goes to 0 the subject-specific VE is flatter, approaching VE=1.  As $\alpha$ goes to 1 the VE for an individual approaches that of the population.
