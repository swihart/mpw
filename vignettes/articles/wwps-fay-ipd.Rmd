...
We accomplished creating the dataset in this package, `ipd_data` by using the R package `IPDfromKM`.  
...
We include this code chunk below but do not run it.  We take the resultant estimates from the `$par` to demonstrate our point.
...
```{r alpha-02-knots-popavg-dist, eval=TRUE, include=FALSE}
